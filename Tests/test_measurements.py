...
class TestMeasurements:
    ...
    def test_D(self):
        ...
        assert np.isclose(mes.D(dm_1, dm_2), 0.3112387179154056 + 0j, 10 ** -6)
    ...
    def test_change_in_extractable_work(self):
        ...
        assert np.isclose(mes.change_in_extractable_work(T_1, dm_1, T_2, dm_1), (0.023494211239722607 + 0j), 10 ** -6)
