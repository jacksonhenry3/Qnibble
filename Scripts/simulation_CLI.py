...
def save_data(file_name: str, data, connectivity, unitary_energy_subspace, unitary_seed, ordering_seed, measurment, num_qubits):
    file_name = file_name + f"-{num_qubits}_qubits-{connectivity}_connectivity-unitary_energy_subspace_{unitary_energy_subspace}-unitary_seed_{unitary_seed}-ordering_seed_{ordering_seed}"
